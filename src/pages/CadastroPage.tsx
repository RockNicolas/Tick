      ...
      <div className="mx-auto w-full max-w-md space-y-4">
        ...
        <section className="space-y-4 rounded-2xl border border-white/10 bg-white/5 p-5 shadow-lg backdrop-blur-md">
          <div className="space-y-1">
            ...
            <p className="text-sm text-zinc-300">Crie sua conta para comecar a usar o Tick.</p>
          </div>
          ...
          <Link to="/auth/login" className="block w-full text-left text-sm text-zinc-300 transition hover:text-white">
