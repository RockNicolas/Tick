      ...
      <div className="mx-auto w-full max-w-md space-y-4">
        ...
        <section className="space-y-4 rounded-2xl border border-white/10 bg-white/5 p-5 shadow-lg backdrop-blur-md">
          <div className="space-y-1">
            ...
            <p className="text-sm text-zinc-300">Entre para acessar sua agenda.</p>
          </div>
            ...
            <label className="block space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="min-h-11 w-full rounded-xl border border-white/15 bg-zinc-900/40 px-3 pr-11 text-sm text-zinc-100 outline-none transition focus:border-red-300/60 focus:ring-2 focus:ring-red-900/40"
                />
                <button
                  type="button"
                  className="absolute right-1.5 top-1/2 inline-flex h-8 w-8 -translate-y-1/2 items-center justify-center rounded-lg text-zinc-300 transition hover:bg-white/10 hover:text-white"
          ...
          <Link to="/auth/cadastro" className="block w-full text-left text-sm text-zinc-300 transition hover:text-white">
