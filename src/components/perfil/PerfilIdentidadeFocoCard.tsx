  ...
  return (
    <section className="rounded-2xl border border-zinc-200/90 bg-white/70 p-4 shadow-sm dark:border-white/10 dark:bg-black/35">
      ...
      <div className="mt-3 flex items-center gap-3">
        <div className="inline-flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl border border-zinc-300/80 bg-zinc-100 text-lg font-semibold text-zinc-800 dark:border-white/15 dark:bg-white/10 dark:text-zinc-100">
          {initials}
        </div>
        <div className="min-w-0">
          ...
          <p className="mt-1 text-[11px] text-zinc-500 dark:text-zinc-500">Membro desde abril de 2026</p>
        </div>
      </div>
    </section>
  )
