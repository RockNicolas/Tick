...
export default function PerfilHeroCard({ initials, userName, userEmail }: PerfilHeroCardProps) {
  return (
    <section className="mx-auto w-full max-w-[220px] self-start rounded-2xl border border-zinc-200/90 bg-white/70 p-3 shadow-sm xl:mx-0 dark:border-white/10 dark:bg-black/35">
